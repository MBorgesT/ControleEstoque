...
public class MaisInfoMovimentacaoEntrada extends javax.swing.JFrame {
    ...
    public MaisInfoMovimentacaoEntrada() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        categoriaButtonGroup.add(jRadioButton1);
        jRadioButton1.setFont(new java.awt.Font("Noto Sans", 0, 14)); // NOI18N
        jRadioButton1.setText("Sim");

        categoriaButtonGroup.add(jRadioButton2);
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cancel_36.png"))); // NOI18N
        jButton5.setText("Cancelar Alterações");

        jButton3.setFont(new java.awt.Font("Noto Sans", 0, 14)); // NOI18N
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/delete_36.png"))); // NOI18N
